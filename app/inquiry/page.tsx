...
const faqs: Array<{ q: string; a: string }> = [
  ...
  {
    q: "누구나 관람할 수 있나요?",
    a: "네. UNIDEV 회원뿐 아니라 일반 관람객도 누구나 자유롭게 참여하실 수 있습니다.",
  },
  {
    q: "입장료가 존재하나요?",
      ...
      <section className="relative -mt-16 md:-mt-24 h-[420px] md:h-[560px] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          ...
          <p className="mt-6 max-w-3xl text-white/90 text-sm md:text-base leading-relaxed font-hero">
            제3회 UNICON에 대한 궁금한 점이나 제안사항이 있으시면 언제든지
            연락해 주세요.
          </p>
        </div>
      </section>
      ...
      <section className="px-4 py-16">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            ...
            <SectionDivider />
            <p className="mt-2 text-[#A9D7FF] tracking-wide">
              제3회 UNICON에 대해 궁금한 점들을 확인해보세요.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="space-y-4 text-brand-highlight">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:officialunidev@gmail.com"
              ...
              <div>
                ...
                <div className="flex items-center gap-3 text-brand-highlight">
                  <a
                    ...
                    className="hover:text-brand-point"
                  >
          ...
          <Card className="md:col-span-2 bg-brand-main/40 border-brand-sub/20 backdrop-blur-sm">
            <CardContent className="p-6">
              ...
              {submitted ? (
                <div className="text-brand-highlight">
                ...
                <form onSubmit={onSubmit} className="space-y-4">
                  ...
                  <Button
                    type="submit"
                    className="w-full bg-brand-sub hover:bg-brand-sub/80 text-white"
                    disabled={loading}
                  >
                    {loading ? "전송 중..." : "문의 보내기"}
                  </Button>
