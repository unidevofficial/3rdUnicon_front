...
export default function Home() {
  ...
  const getCardOpacity = (sectionIndex: number, cardIndex = 0) => {
    ...
    return isMobile
      ? getMobileOpacity(sectionIndex, cardIndex)
      : getDesktopOpacity(sectionIndex, cardIndex);
  };
  ...
  const getSectionScale = (sectionIndex: number) => {
    ...
    // 모바일에서는 고정 픽셀 값 사용, 데스크톱에서는 기존 방식 유지
    const sectionOffset =
      sectionIndex * (isMobile ? 600 : viewportHeight * 0.8);
    const sectionCenter =
      sectionOffset + (isMobile ? 300 : viewportHeight * 0.3);
    const currentScrollPosition =
      scrollY + (isMobile ? 400 : viewportHeight * 0.5);
    ...
    >
      ...
      <section
        ...
        style={{
          ...
          transform: `translateY(${Math.max(
            0,
            (1 - getCardOpacity(0)) * 30
          )}px)`, // Added subtle upward movement
        }}
      >
        {/* <video
        ...
        <div className="relative z-10 max-w-4xl mx-auto space-y-8 px-4">
          ...
          >
            ...
            />
            <h1
              className="font-bold text-white -mt-8 mb-4 no-pretendard px-4"
              style={{
                textShadow:
                  "0 0 30px rgba(150, 190, 255, 0.5), 0 0 70px rgba(150, 190, 255, 0.3), 0 0 100px rgba(255, 255, 255, 0.2)",
              }}
            >
              <div>
                <span className="block leading-none text-[31pt] sm:text-[38pt] md:text-[50pt] lg:text-[66.67pt] tracking-wider">
                  제3회
                </span>
                <span className="block leading-none text-[44pt] sm:text-[53pt] md:text-[71pt] lg:text-[94.7pt] tracking-wide">
                  UNICON
                </span>
              </div>
            </h1>
      ...
      <section
        ...
        style={{
          ...
          transform: `translateY(${Math.max(
            0,
            (1 - getCardOpacity(1)) * 20
          )}px)`, // Added subtle movement
        }}
      >
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-brand-highlight text-center mb-12 mx-auto tracking-wide ">
            UNICON은 대학생 개발자들이 한 해 동안 준비한 프로젝트를 선보이는
            국내 최대 규모의 대학생 개발 전시회입니다.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-brand-point/30">
            ...
            >
              ...
              <p className="text-sm text-brand-highlight/80">
                {" "}
                Contents Universe Korea 2025 행사장
              </p>
            </div>
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-brand-highlight text-center mb-12 tracking-wide">
            UNICON의 다양한 정보를 확인해보세요
          </p>
        ...
        <div className="text-center">
          ...
          <div className="space-y-12">
            ...
            <div>
              <div className="max-w-4xl mx-auto px-4 mb-6">
                <h3 className="text-xl font-semibold text-brand-point">
                  파트너 및 후원
                </h3>
              </div>
          ...
          <div className="mx-auto mt-16">
            <p className="text-base md:text-2xl text-[#8a7a6d] text-center leading-relaxed">
              본 웹페이지는 KRAFTON과 점프가 함께하는 대학 게임 제작 동아리 지원
              프로그램 '베터그라운드 University' 지원으로 제작되었습니다.
            </p>
          </div>
        </div>
      </section>
