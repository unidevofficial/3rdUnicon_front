        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-brand-point/30 bg-brand-main/40 backdrop-blur-sm rounded-xl ">
            {[
              ...
              <div
                key={index}
                className="p-6 text-center hover:bg-brand-main/20 transition-colors duration-300"
              >
                ...
                <div className="text-xl font-bold text-white mb-2 mt-10">
                  {schedule.time}
                </div>
          ...
          <div className="bg-brand-main/40  overflow-hidden backdrop-blur-sm">
            <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-brand-point/30">
              {[
                {
                  title: "게임 시연",
                  desc: "전국 대학생 게임 개발 동아리 팀들의 80여 종 게임 체험",
                },
                ...
                <div
                  key={p.title}
                  className="p-6 hover:bg-brand-main/20 transition-all duration-300"
                >
                  <h3 className="text-xl font-semibold text-white mb-2 pretendard-bold">
                    {p.title}
                  </h3>
